...
@section('content')
<!-- Begin Li's Page Content Area -->
<main class="page-content">
    <!-- Begin Li's Account Page Area -->
                    ...
                    <div class="tab-content myaccount-tab-content" id="account-page-tab-content">
                        <div class="tab-pane fade show active" id="account-dashboard" role="tabpanel"
                            ...
                            <div class="myaccount-dashboard">
                                <p>Hello <b>{{Auth::user()->name }}</b> (not {{Auth::user()->name }}? <a href="{{ route('user.logout') }}">Signout</a>)</p>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:void(0)" class="li-btn li-btn_dark li-btn_sm"><span>View</span></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>On Hold</td>
                                                <td>£162.00 for 2 items</td>
                                                <td><a href="javascript:void(0)" class="li-btn li-btn_dark li-btn_sm"><span>View</span></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="tab-pane fade" id="account-details" role="tabpanel"
                            ...
                            <div class="myaccount-details">
                                <form action="#" class="li-form">
                                    <div class="li-form-inner">
                                        ...
                                        <div class="single-input">
                                            ...
                                            <input type="email" id="account-details-email" value="{{Auth::user()->name }}">
                                        </div>
                                        <div class="single-input">
                                        ...
                                        <div class="single-input">
                                            <button class="li-my-account_btn" type="submit"><span>SAVE CHANGES</span></button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    <!-- Li's Account Page Area End Here -->
</main>
<!-- Li's Page Content Area End Here -->
@endsection
