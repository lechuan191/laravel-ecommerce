              ...
              <table id="example1" class="table table-bordered table-striped table-hover">
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a class="btn btn-info btn-sm" href="{{url('/admin/category/edit-category',$item->id)}}"><i class="fas fa-pencil-alt"></i> Edit</a>
                    <a class="btn btn-danger btn-sm" href="{{url('/admin/category/delete',$item->id)}}"><i class="fas fa-trash"></i> Delete</a>                    {{-- <form action="{{url('/admin/category/delete-category',$item->id)}}" method="PUT">
                      @csrf
                      @method('DELETE')
